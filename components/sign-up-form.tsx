...
export function SignUpForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 sm:px-0 py-6 flex flex-col min-h-[520px]">
      ...
      {/* Google Sign-Up Option (Only on Step 0) */}
      {step === 0 && (
        <div className="mb-6 space-y-3">
          <button
            ...
            disabled={isLoading}
            className="w-full h-12 border-2 border-zinc-300 hover:border-violet-600 hover:bg-violet-50 rounded-lg font-bold text-sm transition-all active:scale-[0.98] flex items-center justify-center gap-3 bg-white shadow-sm disabled:opacity-50"
          >
            ...
            <span className="text-zinc-700 font-black tracking-wide">Sign up with Google</span>
          </button>
          <div className="relative flex items-center gap-4">
            <div className="flex-1 h-px bg-zinc-200"></div>
            <span className="text-[10px] font-black tracking-widest text-zinc-400 uppercase">Or fill the form</span>
            <div className="flex-1 h-px bg-zinc-200"></div>
          </div>
        </div>
      )}
