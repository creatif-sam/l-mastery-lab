...
import { CoopetitionHostClient } from "../../admin/coopetition/coopetition-host-client";

export default async function TutorCoopetitionPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#F9FAFB] dark:bg-[#0B0F1A]">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <TutorHeader title="Coopetition" subtitle="Host real-time quiz battles for your students" />
        <main className="flex-1 overflow-y-auto p-6">
          <CoopetitionHostClient
            currentUser={{ id: profile.id, full_name: profile.full_name ?? "Tutor", role: "tutor" }}
